...
<script>
    ...
    methodsVue = {
        ...
        getJam: function() {
            this.loading = true;
            axios.get('<?= base_url(); ?>api/jampelajaran')
                .then(res => {
                    // handle success
                    this.loading = false;
                    var data = res.data;
        ...
        saveJam: function() {
            this.loading = true;
            axios.post(`<?= base_url(); ?>api/jampelajaran/save`, {
                    jam_ke: this.jamKe,
                    mulai: this.mulai,
        ...
        updateJam: function() {
            this.loading = true;
            axios.put(`<?= base_url(); ?>api/jampelajaran/update/${this.idJam}`, {
                    jam_ke: this.jamKe,
                    mulai: this.mulai,
                    selesai: this.selesai,
                })
        ...
        deleteJam: function() {
            this.loading = true;
            axios.delete(`<?= base_url(); ?>api/jampelajaran/delete/${this.idJam}`)
                .then(res => {
                    // handle success
                    this.loading = false;
                    var data = res.data;
