...
<template>
    <v-card>
        ...
        <v-data-table :headers="dataHeader" :items="dataGuru" :items-per-page="10" :loading="loading" :search="pencarian" class="elevation-0" loading-text="<?= lang('App.loadingWait'); ?>">
            ...
            <v-card>
                ...
                <v-card-text class="pt-5">
                    <v-form ref="form" v-model="valid">
                        <p class="mb-2 text-subtitle-1">Nama Guru & Gelar</p>
                ...
                <v-card-actions>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn large color="primary" @click="saveGuru" :loading="loading" elevation="1">
        ...
        <v-dialog v-model="modalEdit" max-width="700px" persistent scrollable>
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn large color="primary" @click="updateGuru" :loading="loading">
                        <v-icon>mdi-content-save</v-icon> <?= lang('App.save') ?>
                    </v-btn>
                </v-card-actions>
            </v-card>
        ...
        <v-dialog v-model="modalDelete" persistent max-width="600px">
            <v-card class="pa-2">
                ...
                <v-card-actions>
                    ...
                    <v-btn large color="primary" dark @click="deleteGuru" :loading="loading"><?= lang('App.yes') ?></v-btn>
                    <v-spacer></v-spacer>
                </v-card-actions>
            </v-card>
        </v-dialog>
...
<script>
    ...
    methodsVue = {
        ...
        uploadFile: function(file) {
            ...
            this.loading2 = true;
            axios.post(`<?= base_url() ?>api/guru/upload`, formData, {
                    headers: {
        ...
        saveGuru: function() {
            ...
            axios.post(`<?= base_url(); ?>api/guru/save`, {
                    nip_nik: this.nip,
        ...
        updateGuru: function() {
            ...
            axios.put(`<?= base_url(); ?>api/guru/update/${this.idGuru}`, {
                    nip_nik: this.nip,
                    nama_lengkap: this.namaLengkap,
                    tempat_lahir: this.tempatLahir,
                    tanggal_lahir: this.tanggalLahir,
        ...
        deleteGuru: function() {
            this.loading = true;
            axios.delete(`<?= base_url(); ?>api/guru/delete/${this.idGuru}`)
                .then(res => {
                    // handle success
                    this.loading = false;
                    var data = res.data;
