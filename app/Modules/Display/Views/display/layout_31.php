...
<div class="container">
    ...
    <div class="card bg-info text-white border-0">
        <div class="card-header h5 fw-normal">
            <i class="mdi mdi-information"></i> Info terbaru
        </div>
        <div class="card-body transparan">
            <div id="loader2"></div>
            <div id="carouselInfo" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-indicators with-margin" id="navInfo">

                </div>
                <div class="carousel-inner text-center" id="innerInfo">
            ...
            .then(res => {
                ...
                if (data.status == true) {
                    ...
                    for (i = 0; i < dataCuaca_weather.length; i++) {
                        weather += '<h4 class="fw-normal mb-0">' +
