...
<nav class="navbar navbar-dark transparan mb-3">
                ...
                <div class="card-body">
                    <div v-show="dataJampelajaranError">
                        <div class="mb-0 h2 fw-medium text-center" role="alert">
                            <i class="mdi mdi-alert-octagon-outline mdi-48px text-danger"></i><br />
                    ...
                    <div v-else>
                        <h2 class="text-center fw-bold">{{dataKegiatanbelajar.ket}}<br />
                            <small class="fw-medium">{{dataKegiatanbelajar.des}}</small>
                        </h2>
                    </div>
                    ...
                    <div class="tabel-jadwal mt-3" v-else>
                        <table class="table">
        ...
        <div class="col-md-6">
            ...
            <div class="card transparan text-white mb-3">
                <div class="card-body">
                    ...
                    <div v-else-if="dataGuru == '' && loading4 == false">
                        <div class="mb-0 h5 fw-normal" role="alert">
                            <i class="mdi mdi-alert-octagon-outline mdi-24px text-danger"></i> Data Guru kosong
                        </div>
                    </div>
                    <div v-else>
                        <div id="carousel3" class="carousel slide h-100" data-bs-ride="carousel">
                            <div class="carousel-indicators">
                                <button type="button" data-bs-target="#carousel3" v-for="(item, i ) in dataGuru" :key="i" :data-bs-slide-to="i" :class="{ active: i==0 }" aria-current="true" :aria-label="'Slide' + i"></button>
                            </div>
                            <div class="carousel-inner">
                                <div class="carousel-item" v-for="(item, i ) in dataGuru" :key="i" :class="{ active: i==0 }">
                                    <div class="d-flex justify-content-center ">
                                        <img :src="'<?= base_url() ?>' + item.foto" height="100" />
                                    </div>
            ...
            <div class="card transparan text-white mb-3">
                <div class="card-header h5">
                    <i class="mdi mdi-information"></i> Informasi Sekolah
                </div>
                <div class="card-body">
                    ...
                    <div v-else>
                        ...
                        <carousel :autoplay="true" :per-page="1" :loop="true" :autoplay-timeout="<?= $vc_autoplaytimeout; ?>">
                            <slide v-for="(item, i ) in dataInfo" :key="i" :data-index="i" class="mb-4">
                                <h5>{{ item.tgl_news }}</h5>
                                <h4 class="fw-bold">{{ item.text_news }}</h4>
                            </slide>
                        </carousel>
                    </div>
                </div>
...
<script>
    ...
    mountedVue = function() {
        ...
        <?php } else { ?>
            ...
            setInterval(() => this.getGuru(), <?= $news_refresh; ?> * 1000);
            setInterval(() => this.getCuaca(), <?= $cuaca_refresh; ?> * 1000);
        <?php } ?>
