    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="card bg-dark text-white transparan border-0 mb-3">
                <div class="card-header h5">
                    <i class="mdi mdi-weather-cloudy"></i> Prakiraan Cuaca <small class="text-muted">API openweathermap.org</small>
                </div>
                <div class="card-body">
                    <div id="loader"></div>
                    <div id="dataCuaca">
                ...
                if (data.status == true) {
                    ...
                    for (i = 0; i < dataCuaca_weather.length; i++) {
                        weather += '<h4 class="mb-0">' +
                            ' ' + dataCuaca_weather[i].main + ', ' + dataCuaca_weather[i].description + ' <img class="mb-0" src="http://openweathermap.org/img/wn/' + dataCuaca_weather[i].icon + '.png" height="50">' +
                            '</h4>';
                    }
                    if (dataCuaca != null) {
                        $('#dataCuaca').show();
                        $('#cuacaKota').html('<h4 class="fw-bold mb-0">' + dataCuaca.name + ', ' + dataCuaca_sys.country + '</h4>');
            ...
            .then(res => {
                ...
                if (data.status == true) {
                    ...
                    if (dataAgenda != '') {
                        ...
                        $('#carouselAgenda').hide();
                        $('#noAgenda').html('<h5><i class="mdi mdi-alert-octagon-outline mdi-24px text-danger"></i> Belum Ada Agenda Bulan ini</h5>');
                    }
                } else {
                    $('#carouselAgenda').hide();
                    $('#noAgenda').html('<h5><i class="mdi mdi-alert-octagon-outline mdi-24px text-danger"></i> Belum Ada Agenda Bulan ini</h5>');
