            ...
            .then(res => {
                ...
                if (data.status == true) {
                    ...
                    if (dataAgenda != '') {
                        ...
                        for (i = 0; i < dataAgenda.length; i++) {
                            if (i == 0) {
                                ...
                                html += '<div class="carousel-item active">' +
                                    '<h4 class="fw-bold mb-3">' + dataAgenda[i].nama_agenda + ', ' + dataAgenda[i].tgl_agenda + '</h4>' +
                                ...
                                html += '<div class="carousel-item">' +
                                    '<h4 class="fw-bold mb-3">' + dataAgenda[i].nama_agenda + '</h4>' +
                                    '<h4 class="fw-medium">Tempat: ' + dataAgenda[i].tempat_agenda + '</h4>' +
                        ...
                        $('#carouselAgenda').hide();
                        $('#noAgenda').html('<h6><i class="mdi mdi-alert-octagon-outline mdi-24px text-danger"></i> Belum Ada Agenda Bulan ini</h6>');
                    }
                } else {
                    $('#carouselAgenda').hide();
                    $('#noAgenda').html('<h6><i class="mdi mdi-alert-octagon-outline mdi-24px text-danger"></i> Belum Ada Agenda Bulan ini</h6>');
