<?php $this->extend("layouts/display_vue"); ?>
...
<div class="toast-container position-fixed p-3" style="left: 50%;bottom: 10%;transform: translate(-50%, 0px);z-index: 9999;">
	<div id="liveToast" class="toast text-bg-dark border-0 py-1" :class="toast" role="alert" aria-live="assertive" aria-atomic="true">
		<div class="d-flex">
...
<div class="toast-container position-fixed p-3" style="left: 50%;top: 0;transform: translate(-50%, 0px);z-index: 9999;">
	<div id="liveToast2" class="toast text-bg-dark border-0 py-0" :class="toastFullscreen" role="alert" aria-live="assertive" aria-atomic="true">
		<div class="d-flex">
			<div class="toast-body">
...
<script>
	dataVue = {
		...dataVue,
		toastFullscreen: "show",
	}

	beforeMountVue = function() {
		setTimeout(() => {
			this.toastFullscreen = "hide";
		}, 10000); // 10 detik
	}
