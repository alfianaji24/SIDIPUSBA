...
<template>
    <v-card>
        ...
        <v-data-table :headers="dataHeader" :items="dataDokter" :items-per-page="10" :loading="loading" :search="pencarian" class="elevation-0" loading-text="<?= lang('App.loadingWait'); ?>">
            ...
            <v-card>
                ...
                <v-card-text class="pt-5">
                    <v-form ref="form" v-model="valid">
                        <p class="mb-2 text-subtitle-1">Nama Dokter & Gelar</p>
                        <v-text-field v-model="namaLengkap" :error-messages="nama_lengkapError" outlined></v-text-field>
                        ...
                        <v-row>
                            ...
                            <v-col>
                                <p class="mb-2 text-subtitle-1">Spesialis</p>
                                <v-text-field v-model="spesialis" :error-messages="spesialisError" outlined></v-text-field>
                            </v-col>
                        </v-row>
                ...
                <v-card-actions>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn large color="primary" @click="saveDokter" :loading="loading" elevation="1">
        ...
        <v-dialog v-model="modalEdit" max-width="700px" persistent scrollable>
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn large color="primary" @click="updateDokter" :loading="loading">
                        <v-icon>mdi-content-save</v-icon> <?= lang('App.save') ?>
                    </v-btn>
                </v-card-actions>
            </v-card>
        ...
        <v-dialog v-model="modalDelete" persistent max-width="600px">
            <v-card class="pa-2">
                ...
                <v-card-actions>
                    ...
                    <v-btn large color="primary" dark @click="deleteDokter" :loading="loading"><?= lang('App.yes') ?></v-btn>
                    <v-spacer></v-spacer>
                </v-card-actions>
            </v-card>
        </v-dialog>
...
<script>
    ...
    methodsVue = {
        ...
        uploadFile: function(file) {
            ...
            this.loading2 = true;
            axios.post(`<?= base_url() ?>api/dokter/upload`, formData, {
                    headers: {
        ...
        saveDokter: function() {
            ...
            axios.post(`<?= base_url(); ?>api/dokter/save`, {
                    nip_nik: this.nip,
        ...
        updateDokter: function() {
            ...
            axios.put(`<?= base_url(); ?>api/dokter/update/${this.idDokter}`, {
                    nip_nik: this.nip,
                    nama_lengkap: this.namaLengkap,
                    tempat_lahir: this.tempatLahir,
                    tanggal_lahir: this.tanggalLahir,
        ...
        deleteDokter: function() {
            this.loading = true;
            axios.delete(`<?= base_url(); ?>api/dokter/delete/${this.idDokter}`)
                .then(res => {
                    // handle success
                    this.loading = false;
                    var data = res.data;
